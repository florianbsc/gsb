...
<body>
    <h1>ici sera la page responsable</h1>
    ...
    <form action="">
        ...
        <input type="text" name="" placeholder="Mail"><br>
        <input type="password" name="mail_employe" placeholder="Mot de Passe"><br>

        <select>
            @foreach($regions as $region)
                <option value="{{ $region->nom_region }}">{{ $region->nom_region .' du secteur : '. $region->nom_secteur }}</option>
            @endforeach
        </select><br>
        <input type="submit">
